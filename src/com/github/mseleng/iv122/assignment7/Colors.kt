 ...
 */
val innerForLinePurple = Pair(Color.BLACK, Color.BLACK)
 ...
 */
val innerForLightBlueBrown = Pair(Color.BLACK, Color.BLACK)
 ...
 */
val innerForIndigoGray = Pair(Color.BLACK, Color.BLACK)

/**
 * Colors for the newton fractal
 */
val newtonColors = listOf(
